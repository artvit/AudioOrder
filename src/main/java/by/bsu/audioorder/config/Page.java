...
public class Page {
    ...
    public static final String TRACKS = "/pages/tracks.jsp";
    public static final String USERS = "/pages/users.jsp";
    public static final String TRACK_INFO = "/pages/track-info.jsp";
    public static final String TRACK_ADD = "/pages/track-add.jsp";
    public static final String TRACK_ADD_SUCCESS = "/pages/track-add-success.jsp";
